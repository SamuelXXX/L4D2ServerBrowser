...
/// <summary>
/// A singleton that can be destroyed when scene unloaded
/// </summary>
/// <typeparam name="T"></typeparam>
public class ShortLifeSingleton<T> : MonoBehaviour where T : ShortLifeSingleton<T>
{
    ...
    protected virtual void Awake()
    {
        if (IsInitialized && instance != this)
        {
            ...
            Debug.LogWarningFormat("Trying to instantiate a second instance of singleton class {0}. Additional Instance was destroyed", GetType().Name);
        }
