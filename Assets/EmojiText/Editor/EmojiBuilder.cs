...
public class EmojiBuilder  {
	...
	private const string OutputPath = "Assets/EmojiText/Emoji/Output/";
	private const string InputPath = "/EmojiText/Emoji/Input/";
	...
	public static void BuildEmoji()
	{
		...
		File.Copy (OutputPath + "emoji.txt","Assets/EmojiText/Resources/emoji.txt",true);
