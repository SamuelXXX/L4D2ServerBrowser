...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(MySql.Data.MySqlClient.MySqlDataReader p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(SQLRequestAgent.SQLDataReaderCallback))
			{
			    return new SQLRequestAgent.SQLDataReaderCallback(__Gen_Delegate_Imp11);
			}
